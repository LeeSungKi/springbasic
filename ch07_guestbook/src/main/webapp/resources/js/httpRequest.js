var xhr = null;//전역변수설정 일단null로설정함 XMLHttpRequest 객체( = request 객체)
...
//그러면 Mozzlia, Safari나 다른 브라우저에서도 Microsoft의 ActiveX 객체의 method와 property를 지원하기 위해 XMLHttpRequest클래스를 구현 하고 있다.
	...
	/*if(window.ActiveXObject)
		...
		xhr = new XMLHttpRequest();//request 생성
}


function sendRequest(url, param, callBack, method){ //callBack : ajax 통신을 완료한 후 실행할 함수
	...
	xhr.setRequestHeader("Content-Type",/*이름*/
	  "application/x-www-form-urlencoded");/*값*/
